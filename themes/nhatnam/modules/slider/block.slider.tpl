<!-- BEGIN: main -->
<link href="{NV_BASE_SITEURL}themes/{TEMPLATE}/css/cssvinh/slider_pro.css" type="text/css" media="all" rel="stylesheet" />

<script src="{NV_BASE_SITEURL}themes/{TEMPLATE}/js/jsvinh/jssor.slider.min.js"></script>
...
<div id="slider1_container" style="position: relative; width: 1920px; height: 720px; overflow: hidden; margin-bottom:50px">
	<!-- Loading Screen --> 
        <div u="loading" style="position: absolute; top: 0px; left: 0px;">
            <div style="filter: alpha(opacity=70); opacity:0.7; position: absolute; display: block;
                background-color: #000; top: 0px; left: 0px;width: 100%; height:100%;"> 
            </div> 
            <div style="position: absolute; display: block; background: url({NV_BASE_SITEURL}themes/{TEMPLATE}/images/loading.gif) no-repeat center center;
                top: 0px; left: 0px;width: 100%;height:100%;">
            </div> 
        </div> 
		
	<!-- Slides Container --> 
    <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1920px; height: 720px">
			<!-- BEGIN: loop -->
            <div>
				<img u="image" src="{DATA.image}" alt = "{DATA.title}"/>	
				<div u=caption t="T" t2=NO style="position: absolute; right: 160px; top:60px; width:600px; height:90px; color: #fff; line-height: 60px; text-align: center; font-size:50px">
					{DATA.title}
					<p>{DATA.hometext}</p>
                </div>
			</div>
...
<span u="arrowleft" class="jssora20l" style="top: 50% !important; left: 230px;">  
        </span>
        <!-- Arrow Right -->
        <span u="arrowright" class="jssora20r" style="top: 50% !important; right: 230px;">
        </span>
		<style>
            ...
            */
            ...
            .jssora20l {  background: url({NV_BASE_SITEURL}themes/{TEMPLATE}/images/button-left-2.png) no-repeat; }
			
            .jssora20r {  background: url({NV_BASE_SITEURL}themes/{TEMPLATE}/images/button-right-2.png) no-repeat;}
			
            .jssora20l:hover {  background: url({NV_BASE_SITEURL}themes/{TEMPLATE}/images/button-left-1.png) no-repeat; }
			
            .jssora20r:hover {  background: url({NV_BASE_SITEURL}themes/{TEMPLATE}/images/button-right-1.png) no-repeat;}
